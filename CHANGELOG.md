...
* Drop Go 1.16 support ([#38](https://github.com/tier4/x-go/issues/38))
* Remove popx ([#36](https://github.com/tier4/x-go/issues/36))
* Bump pop to v6 ([#34](https://github.com/tier4/x-go/issues/34))

### Features

* add Go 1.22 support ([#59](https://github.com/tier4/x-go/issues/59)) ([0037862](https://github.com/tier4/x-go/commit/0037862da7cd270c528c65a6f6d2f119c4e08946))
...
* drop Go 1.19 to 1.21 supports and newly support Go 1.23 ([#73](https://github.com/tier4/x-go/issues/73)) ([db23e56](https://github.com/tier4/x-go/commit/db23e56a720ac290c9b204f9b12e101da3f264aa))
* drop support Go v1.18  and add support Go v1.19 later ([#52](https://github.com/tier4/x-go/issues/52)) ([76f6b7c](https://github.com/tier4/x-go/commit/76f6b7c8308441a52ef89fe66e934d7b87ae5394))
...
* introduce random package ([#58](https://github.com/tier4/x-go/issues/58)) ([61ff285](https://github.com/tier4/x-go/commit/61ff285ca303156e4d5b471e2e6855e6b69821ed))
...
* **popx:** Reset migration helper ([#20](https://github.com/tier4/x-go/issues/20)) ([7333ad4](https://github.com/tier4/x-go/commit/7333ad404fe511df33248890d6de468bf047997a))
* Utility function: Ref and Deref ([#42](https://github.com/tier4/x-go/issues/42)) ([cd34ba9](https://github.com/tier4/x-go/commit/cd34ba9722cd0f0aac1561230d59fdcfe37a9005))
* **zstdx:** uncompress with custom size limit ([#70](https://github.com/tier4/x-go/issues/70)) ([fb2345e](https://github.com/tier4/x-go/commit/fb2345e14aa356ca6f7af9d47fba9b7131110e66))


### Bug Fixes

* Bump pop to v6 ([#34](https://github.com/tier4/x-go/issues/34)) ([a1fdcc2](https://github.com/tier4/x-go/commit/a1fdcc2d367f4a2f002f6cabd57d7bcf1637f321))
* CI token ([1a98085](https://github.com/tier4/x-go/commit/1a9808515b2592666acb0a6eb079ab983cfedcfb))
* CVE-2021-42576 github.com/microcosm-cc/bluemonday ([#27](https://github.com/tier4/x-go/issues/27)) ([62884e5](https://github.com/tier4/x-go/commit/62884e50964b8fb04e2a12f21561a0ccada4a2e1))
...
* Drop Go 1.16 support ([#38](https://github.com/tier4/x-go/issues/38)) ([ef30f00](https://github.com/tier4/x-go/commit/ef30f00eca5acc25b85054f2ee3c2e85a8f4e797))
* **popx:** Connection.Store compatible with sqlx.QueryerContext ([#25](https://github.com/tier4/x-go/issues/25)) ([0e499fd](https://github.com/tier4/x-go/commit/0e499fd4ecb4da0600bf53fd76706bc4c2824b06))
